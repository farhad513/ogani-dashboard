...
import { get_admin_dashboard } from "../../store/reducers/indexReducer";
    ...
    <div className="px-2 md:px-7 py-5">
        ...
        <div className="w-full lg:w-5/12 lg:pl-4 mt-6 lg:mt-0">
          <div className="w-full bg-[#283046] p-4 rounded-md text-white">
            <div className="flex justify-between items-center">
              <h2 className="font-semibold text-lg">Recent Seller Message</h2>
      ...
      <div className="w-full p-4 bg-[#283046] rounded-md mt-6">
        <div className=" flex justify-between text-white items-center">
          ...
          <Link to={"/admin/dashboard/orders"} className="text-sm ">
            View All
          </Link>
        </div>
